<script lang="ts">
    ...
    import SearchIcon from "$lib/icons/web.svg?component";
            ...
            <div class="space-y-2">
                {#each $settings.search_engines as searchEngine}
                    ...
                    >
                        ...
                        <div class="p-1 pl-2 pr-2 bg-secondary rounded-md">
            ...
            <div>
                {#if $state.blacklisted_apps.length === 0}
                    <p class="text-secondary">
                        No blacklisted apps. Click on the add button to add apps
                    </p>
                {/if}
                ...
                <div class="space-y-2 mt-2">
                    {#each $state.blacklisted_apps as app}
                        <div
                            class="flex space-x-4 p-2 border border-secondary rounded-lg items-center"
                        >
                            ...
                            {:else}
                                <FileIcon
                                    class="h-[32px] w-[32px] text-accent"
                                />
                            {/if}
